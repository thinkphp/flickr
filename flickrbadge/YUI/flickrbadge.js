                     ...
                     YAHOO.example.flickrbadge = function() { 
                        ...
                        //variables to change
                            ...
                            function compute(o) { 
                                 ...
                                 var oldori = d.getElementById(o.link.replace(reg,''));
                                ...
                                var outlist = d.createElement('ul');

                                    YD.addClass(outlist,navClass);

                                var li = d.createElement('li');
                                var back = d.createElement('a');
                                    back.href = '#';
                                    YE.on(back,'click',navigate,{dir:-1,id:id}); 
                                    back.innerHTML = prevHTML;
                                    li.appendChild(back);
                                ...
                                var li = d.createElement('li');
                                var fwd = d.createElement('a');
                                    fwd.href = '#';            
                                    YE.on(fwd,'click',navigate,{dir:1,id:id});
                                    fwd.innerHTML = nextHTML;
                                    li.appendChild(fwd);
                                    outlist.appendChild(li); 

                               ori.appendChild(outlist);
                                ...
                                var a = d.createElement('a');
                                   ...
                                   YD.addClass(bs[id].sets[0],currentClass);       

                            }; 


                            function navigate(e,o){

                                   var b = bs[o.id];

                                       YD.removeClass(b.sets[b.current],currentClass); 

                                       b.current = b.current + o.dir; 
                                      ...
                                      if(b.current === -1) {b.current = 3;}
                                       ...
                                       YD.addClass(b.sets[b.current],currentClass); 
                            ...
                            function show(e,o) {
                                  ...
                                  if(t.nodeName.toLowerCase() === 'img') {
                                           ...
                                           var id = this.parentNode.id;
                                                        ...
                                                        if(bs[id].img) { bs[id].img.parentNode.removeChild(bs[id].img); }

                                           var img = document.createElement('img');

                                               img.src = t.src.replace('_s','_m');

                                               YE.on(img,'click',function(){
                                                                             bs[this.parentNode.id].img = null;    
                                                                             YD.removeClass(this.parentNode,openClass);                                                                               
                                                                             this.parentNode.removeChild(this);                                                                              
                                                                           });

                                               YD.addClass(img,bigImageClass);
                                               this.parentNode.appendChild(img);
                                               YD.addClass(this.parentNode,openClass); 
                                               bs[this.parentNode.id].img = img; 
                            ...
                            var a = YD.getElementsByClassName(containerClass,'div');
...
function jsonFlickrFeed(o) {
     ...
     YAHOO.example.flickrbadge.compute(o);

};

YAHOO_config = {listener: YAHOO_config_run};
