             ...
             setCaption: function()
                {
                 ...
                 $('Counter').setHTML((photoId) + '/'+ (this.photoNum));
                },
             ...
             initSwap: function()
                ...
                createThumbs: function(rsp)
                  ...
                  nextImage: function()
                    ...
                    photoId = (photoId == (this.photoNum - 1) ) ? 0 : photoId + 1; 
                    this.initSwap();  
                  ...
                  prevImage: function()
                    ...
                    photoId = (photoId == 0 ) ? (this.photoNum - 1) : photoId - 1; 
                    this.initSwap();  
			...
			el.addEvent("click", function(e) {
				...
				new Event(e).stop()
                    ...
                    $('ViewThumbs').addEvent('click', function(){
                                     ...
                                     if(hasThumbs == false) {this.createThumbs(this.rsp);this.setActiveThumb();}
